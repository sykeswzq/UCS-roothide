...
DEB = sys.argv[1] if len(sys.argv) > 1 else r"C:\Users\Administrator\Desktop\UCS-roothide\com.sykes.ucs_1.0.7_iphoneos-arm64e.deb"
ok = True
...
check("control Version=1.0.7", "Version: 1.0.7" in control_text)
